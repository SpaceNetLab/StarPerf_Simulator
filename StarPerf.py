...
def main():
    ...
    here is set to 100 seconds, although I generated 1000 seconds of traffic in the experiment.
    """
    ...
    """
    Energy consumption attacks require longer traffic generation time (about 300s)
    """
