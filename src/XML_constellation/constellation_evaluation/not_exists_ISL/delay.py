...
import src.XML_constellation.constellation_entity.POP as POP_POINT
...
def delay(source , target , dT , sh , ground_station_file , POP_file , α = 1.1 , β = 1.0 , minimum_elevation = 25):
    ...
    for t in range(1, (int)(sh.orbit_cycle / dT) + 2, 1):
        ...
        sourcesatellite_x,sourcesatellite_y,sourcesatellite_z = latilong_to_descartes(satellite_to_source , "satellite" , t)
        distance_between_source_and_sourcesatellite = math.sqrt((source_x-sourcesatellite_x)**2 + (source_y-sourcesatellite_y)**2
        ...
        distance_between_sourcesatellite_and_sourceGS = math.sqrt((sourceGS_x-sourcesatellite_x)**2+(sourceGS_y-sourcesatellite_y)**2
                                                                  +(sourceGS_z-sourcesatellite_z)**2) / 1000.0
        # calculate the distance between nearest_GS_to_source → nearest_POP_to_sourceGS, unit: km
        distance_between_sourceGS_and_sourceGSPOP = distance_two_terrestrial_point(nearest_GS_to_source , nearest_POP_to_sourceGS)
        # calculate the distance between nearest_POP_to_sourceGS → nearest_POP_to_targetGS, unit: km
        distance_between_sourceGSPOP_and_targetGSPOP = distance_two_terrestrial_point(nearest_POP_to_sourceGS , nearest_POP_to_targetGS)
        # calculate the distance between nearest_POP_to_targetGS → nearest_GS_to_target, unit: km
        distance_between_targetGS_and_targetGSPOP = distance_two_terrestrial_point(nearest_GS_to_target , nearest_POP_to_targetGS)
        ...
        targetsatellite_x, targetsatellite_y, targetsatellite_z = latilong_to_descartes(satellite_to_target, "satellite", t)
        distance_between_targetGS_and_targetsatellite = math.sqrt((targetGS_x-targetsatellite_x)**2 + (targetGS_y-targetsatellite_y)**2
        ...
        distance_between_targetsatellite_and_target = math.sqrt((target_x-targetsatellite_x)**2 + (target_y-targetsatellite_y)**2
