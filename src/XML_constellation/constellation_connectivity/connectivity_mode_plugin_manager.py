...
class connectivity_mode_plugin_manager:
    def __init__(self):
        ...
        # src/XML_constellation/constellation_connectivity/connectivity_plugin folder,
        ...
        # collection.
        package_name = "src.XML_constellation.constellation_connectivity.connectivity_plugin"
        ...
        # +Grid.
        self.current_connection_mode = "positive_Grid"
