...
def natural_failure_satellites():
    ...
    constellation_natural_failure = constellationDamageModelPluginManager.\
        execute_damage_model(constellation , constellation.shells[0] , 0.05 , dT)
    ...
    delay2 = DELAY.delay(constellation_natural_failure.constellation_name, source, target, dT,
                         constellation_natural_failure.shells[0])
    ...
    minimum_path = routingPolicyPluginManager.execute_routing_policy(constellation_natural_failure.constellation_name, source, target,
                                              constellation_natural_failure.shells[0])
    ...
    betweeness2 = BETWEENESS.betweeness(constellation_natural_failure.constellation_name, constellation_natural_failure.shells[0])
    ...
    bandwidth1 = BANDWIDTH.bandwidth(constellation.constellation_name, source, target, constellation.shells[0], 1.1, 5,
                                     dT)
    ...
    bandwidth2 = BANDWIDTH.bandwidth(constellation_natural_failure.constellation_name, source, target,
                                     constellation_natural_failure.shells[0], 1.1, 5, dT)
